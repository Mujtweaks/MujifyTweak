...
export const WHATS_NEW = {
  ...
  notes: [
    ...
    "🎯 The in-game FPS/temp overlay moved to the Home page so it’s front-and-centre, and Game Mode is now wired to Windows’ real Game Mode (and remembers its state).",
