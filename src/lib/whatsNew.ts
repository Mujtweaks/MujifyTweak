...
export const WHATS_NEW = {
  ...
  headline: "Cleaner library, safer everything.",
  notes: [
    "🎮 Cleaner Games library — Epic Online Services, Riot Client/Vanguard and other launchers/services no longer show as games, and duplicate Roblox entries collapse into one.",
