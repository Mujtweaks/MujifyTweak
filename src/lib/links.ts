...
/** Where users read what changed. Points at GitHub Releases because it is
 *  generated by the release pipeline, so it can never fall behind the build.
 *  The website has no /updates page yet (it 404s) — once it exists, this is a
 *  one-line swap and both popups follow it. */
export const UPDATES_PAGE = GITHUB_RELEASES;
